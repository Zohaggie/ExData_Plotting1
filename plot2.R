# Plot2.R - Downloads data zip file if required, unpacks it if required,
...
# Create png to satisfy requirements of graph 2, which is a line plot
# of Global Active Power over the 2 days of data
png(filename = "plot2.png", width=480, height=480)
plot(chartdata$DateTime, chartdata$Global_active_power, type="l",
     ylab = "Global Active Power (kilowatts)", xlab = "")
dev.off()

message("Chart saved as Plot2.png, see readme.md for instructions on using it.")
