# Plot1.R - Downloads data zip file if required, unpacks it if required,
...
# Create png to satisfy requirements of graph 1, which is a histogram
# of Global Active Power
png(filename = "plot1.png", width=480, height=480)
hist(chartdata$Global_active_power, col="red", main = "Global Active Power",
     ylab = "Frequency", xlab = "Global Active Power (kilowatts)")
dev.off()

message("Chart saved as Plot1.png, see readme.md for instructions on using it.")
